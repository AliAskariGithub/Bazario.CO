            ...
            <button
              ...
              className={`w-max text-sm flex items-center justify-center gap-1 shadow-lg p-2 border rounded-md duration-200 transition ${
                isSubmitting
                  ...
                  : "dark:bg-[rgb(23,23,23)] dark:hover:bg-white dark:hover:text-black dark:border-white bg-white border-black hover:text-white hover:bg-[rgb(23,23,23)]"
              }`}
            >
            ...
            <div className="p-6 border rounded-lg shadow-lg bg-white transition duration-150 flex flex-col justify-center items-center">
              ...
              <div className="flex gap-6 justify-center">
                ...
                >
                  <FaFacebookF
                    size={28}
                    className="text-white bg-blue-500 rounded-full p-[3px] hover:bg-blue-600 transition"
                  />
                </Link>
                <Link
                ...
                >
                  <FaTwitter
                    size={28}
                    className="text-white bg-sky-400 rounded-full p-[3px] hover:bg-sky-500 transition"
                  />
                </Link>
                <Link
                ...
                >
                  <FaLinkedinIn
                    size={28}
                    className="text-white bg-blue-500 rounded-full p-1 hover:bg-blue-600 transition"
                  />
                </Link>
              </div>
            </div>
