...
import { COUPON_CODE_2 } from "@/sanity/lib/sale/couponCode";
...
const BasketPage = () => {
  ...
  const handleCouponSubmit = () => {
    ...
    Object.keys(COUPON_CODE_2).forEach((key) => {
      if (
        (
          COUPON_CODE_2[
            key as keyof typeof COUPON_CODE_2
  ...
  return (
    <>
    <Breadcrumb className="absolute sm:top-16 left-5 mt-2 sm:mt-0">
      <BreadcrumbList>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-gray-100 p-4 rounded-lg text-sm text-gray-700">
                            ...
                            <ul className="list-disc pl-4 space-y-1">
                              ...
                              <li>
                                Returns are accepted for defective or incorrect
